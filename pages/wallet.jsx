              ...
              <Card shadow="xl" p="lg" withBorder>
                <Card.Section>
                  <Group justify="right">
                    <CopyButton value={currentUser.PublicKeyBase58Check} timeout={2000}>
                      {({ copied, copy }) => (
                        <Tooltip
                          label={copied ? 'Copied' : 'Copy Your Public Key'}
                          withArrow
                          position="right"
                        >
                  ...
                  <Text fw={500} c="dimmed" ta="center">
                    {userDesoBalance} $DESO = ${usdBalance} USD
                  </Text>
                  <Space h="lg" />
                </Card.Section>
                ...
                <Group>
                  <Blockquote
                    ...
                    mt="xl"
                  >
                    Your DeSo Wallet Address will be used and 50% of fees will be paid out to you.
                    This is paid out after $50 worth of fees.
                  </Blockquote>
                </Group>
